...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { cation: @advertisement.cation, imageUrl: @advertisement.imageUrl, username: @advertisement.username } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { cation: @advertisement.cation, imageUrl: @advertisement.imageUrl, username: @advertisement.username } }
